...
exports.searchSkillsSchema = void 0;
exports.searchSkillsHandler = searchSkillsHandler;
exports.createSearchSkillsTool = createSearchSkillsTool;
...
exports.searchSkillsSchema = zod_1.z.object({
    keyword: zod_1.z.string().describe('Search keyword. Can be English, Chinese, or mixed. (e.g., "React", "n8n-workflow", "frontend development", "copywriting", "langchain docs")'),
    categories: zod_1.z.array(zod_1.z.enum(CATEGORIES)).optional().describe('Optional category filter. Supports both English and Chinese category names. Can pass multiple categories. (e.g., ["Frontend Development", "AI & Machine Learning"])'),
    limit: zod_1.z.number().min(1).max(100).optional().describe('Limit the number of results returned. Default is 10, maximum is 100. Set according to your needs to avoid returning too many results.'),
});
async function searchSkillsHandler(args) {
...
function createSearchSkillsTool() {
    return {
        name: 'search_skills',
